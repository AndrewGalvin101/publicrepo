...
namespace BattleShip.BLL.GameLogic
{
    public class Board
    {
        ...
        // Added to enable GameFlow to access ShotHistory
        public ShotHistory GetShotHistory(Coordinate toCheck)
        {
            if (ShotHistory.ContainsKey(toCheck)) return ShotHistory[toCheck];
            else return Responses.ShotHistory.Unknown;
        }
    }
}
